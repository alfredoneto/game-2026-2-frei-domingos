...
for (let locaismoedas of tiles.getTilesByType(assets.tile`marcador`)) {
    moeda = sprites.create(img`
        ...
        . . f f f . . . 
        `, SpriteKind.Food)
    tiles.placeOnTile(moeda, locaismoedas)
    tiles.setTileAt(locaismoedas, assets.tile`baseTransparency16`)
}
